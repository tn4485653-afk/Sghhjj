...
# ===== AUTO BOT CONFIG =====
AUTO_BOTS = [
    # Put your bot access tokens here
    "aad0e741b3d0d7a35aa65663beeecc3e7173ece700740a76c13e61d320e578cc"
]
...
× Create squads:
 ...
 => /5 123x
 => /6 123x
 "[C][B][007AFF]@[C][B][339BFF]s[C][B][66BBFF]i[C][B][99DFFF]k"
    "[C][B][CCF5FF]i[C][B][E0FAFF]b[C][B][F0FDFF]didev"
× Spam inv:
 => /sinv 123
 » spam vào đội
 => /rinv 123
